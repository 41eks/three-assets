    ...
    (function (threejs) {
        class MeshBatcher extends THREE.Mesh {
            constructor(maxVertices = 10920, materialCustomizer = (parameters) => { }) {
                ...
                this.geometry = geo;
                this.material = new threejs.SkeletonMeshMaterial(materialCustomizer);
            }
            dispose() {
            ...
            batch(vertices, verticesLength, indices, indicesLength, z = 0) {
                ...
                // 👇 1. 加上安全保护，现代 Three.js 会直接跳过这里
                if (this.vertexBuffer.updateRange) {
                ...
                // 👇 2. 这里的 Index 缓冲区同样加上安全保护
                if (geo.getIndex().updateRange) {
...
(function (spine) {
    ...
    (function (threejs) {
        ...
        class SkeletonMesh extends THREE.Object3D {
            constructor(skeletonData, materialCustomizer = (parameters) => { }) {
                super();
            ...
            nextBatch() {
                if (this.batches.length == this.nextBatchIndex) {
                    let batch = new threejs.MeshBatcher(10920, this.materialCustomizer);
                    this.add(batch);
...
(function (spine) {
    var threejs;
    (function (threejs) {
        class ThreeJsTexture extends spine.Texture {
            constructor(image) {
                super(image);
