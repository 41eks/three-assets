...
const SPINE_BASE_URL = `${baseUrl}spine-assets/05/`;
const SKEL_FILE = "05.json";
const ATLAS_FILE = "05.atlas";
...
link.rel = 'preload';
link.as = 'image';
link.href = `${SPINE_BASE_URL}05.png`;
...
const popups = [
{
    ...
    imgSrc: `${baseUrl}refer/BV1b14y1o72E.webp`,
    text: '编辑网格+分配权重+果冻小怪兽',
    link: 'https://www.bilibili.com/video/BV1b14y1o72E/',
    delay: 2000,      // 2秒后显示
...
export default {
    enter,
    leave,
    assets: [createWait(assetManager, parseAssets, postParse, { skel: SKEL_FILE, atlas: ATLAS_FILE, png: `${SPINE_BASE_URL}05.png` })],
    options: { hdr: false },popups
};